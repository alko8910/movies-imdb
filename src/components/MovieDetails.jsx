        ...
        <Grid container >
          <Grid item>
            <img
              ...
              style={{ width: "400px", marginRight: "25px", maxHeight: '400px' }}
            />
          </Grid>
          <Grid >
            <div className={classes.div}>Rating: {movieInfo.ratings.rating}</div>
            <div className={classes.div}>Top Rank: {movieInfo.ratings.topRank}</div>
